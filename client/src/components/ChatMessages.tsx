    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-500">Starting new conversation...</p>
        </div>
      </div>
    );
  }
      ...
      {messages.length === 0 ? (
        <div className="flex justify-center">
          <div className="max-w-md text-center">
            ...
            <h3 className="text-lg font-medium text-slate-900 mb-2">Welcome to Pike</h3>
          ...
          <div key={message.id} className={`flex ${message.role === 'user' ? 'justify-end' : 'justify-start'}`}>
            {message.role === 'user' ? (
              <div className="max-w-lg">
                ...
                <div className="flex items-center justify-end mt-1 space-x-2 text-xs text-slate-500">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-white border border-slate-200 rounded-2xl rounded-tl-md px-4 py-3 shadow-sm">
                      <p className="text-sm text-slate-900 whitespace-pre-wrap" data-testid={`message-assistant-${message.id}`}>
                          ...
                          <div className="space-y-2">
                            {(message.sources as Source[]).map((source: Source, index: number) => (
                              <div key={index} className="flex items-center space-x-2 text-xs">
                                ...
                                <span className="text-slate-700 truncate">{source.filename}</span>
