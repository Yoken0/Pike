  ...
  return (
    <>
        ...
        <div className="space-y-3">
          <div 
            className={`border-2 border-dashed rounded-lg p-4 text-center transition-colors cursor-pointer ${
              dragOver ? 'border-blue-500 bg-blue-50' : 'border-slate-300 hover:border-blue-500'
            }`}
          ...
          >
            ...
            <p className="text-xs text-slate-400">PDF, TXT, DOCX supported</p>
            <input 
              id="file-input"
              type="file" 
              className="hidden" 
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4">
          <h3 className="text-sm font-medium text-slate-700 mb-3">Recent Documents</h3>
          <div className="space-y-2">
            {documents.length === 0 ? (
              <div className="text-center py-8 text-slate-500">
                <FileText className="h-8 w-8 mx-auto mb-2 text-slate-300" />
                <p className="text-sm">No documents yet</p>
                <p className="text-xs text-slate-400">Upload files or search to get started</p>
              </div>
            ) : (
              documents.map((doc) => (
                <div 
        ...
        <div className="p-4 border-t border-slate-100">
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-slate-600">Vector Database</span>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="text-slate-900 font-medium" data-testid="text-documents-count">
